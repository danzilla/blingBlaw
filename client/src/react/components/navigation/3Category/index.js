...
const AccountCategory = (props) => {
  ...
  return (
    <>
      ...
      <Modal title={<Title level={3}>Labels, Tags and Categories</Title>} visible={ModalVisible} footer={null}
        centered onOk={() => setModalVisible(false)} onCancel={() => setModalVisible(false)}>
          <Row justify="center">
            <Form layout="inline">
