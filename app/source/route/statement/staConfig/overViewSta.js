...
module.exports = {
  // POST
  // postLogin module
  overViewSta: function(req, res, next) {
    // get session info
    ...
    if (!req.session.user) {
      ...
      collectionBling.findOne({
        ...
        let _data = "overViewStaoverViewStaoverViewStaoverViewStaoverViewStaoverViewStaoverViewSta";
        ...
        console.log("loadDash_ " + JSON.stringify(_data));
